...
from src.constants import LIST_OF_COL_NAMES_OF_MAVE_GS_DF, TRAINING_FLAG_SUFFIX, MUTEPRED_TOOL_NAME, \
    ...
    DEOGEN_AMINO_ACID_CHANGE_COLUMN, COLUMN_NAME_OF_MAVE_GOLD_STANDARD_UNIPROT_ID, COLUMN_NAME_OF_MAVE_GOLD_STANDARD_ID, \
    DEOGEN_TOOL_NAME
...
DEOGEN_TRAINING_SNPS_COLUMN_NAME = DEOGEN_TOOL_NAME + TRAINING_SNPS_COLUMN_SIFFIX
