...
from src.utils import COLUMN_NAMES_OF_MAVE_GS_DATAFRAME_LIST, get_mave_tool_scores_dataframe, \
    get_correlation_and_percentage_used, pickle_dataframe
import copy
...
if __name__ == '__main__':
    ...
    mave_score_dict = \
    MAVE_GS_DATAFRAME.loc[MAVE_GS_DATAFRAME['protein_name'] == protein_name, MAVE_SCORE_DICTIONARY_COLUMN_NAME].values[0]
    tool_score_dict = \
    MAVE_GS_DATAFRAME.loc[MAVE_GS_DATAFRAME['protein_name'] == protein_name, MUTEPRED_SCORE_COLUMN_NAME].values[0]
    ...
    result = get_correlation_and_percentage_used(mave_mutepred_scores_df, MAVE_SCORE_COLUMN_NAME,
