...
if __name__ == '__main__':
    ...
    MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE = add_column_from_tool_df_to_mave_df(mave_df=MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE,
    ...
    MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE = add_flag_column(df=MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE,
                                        target_column=MUTEPRED_TRAINING_SNPS_COLUMN_NAME,
                                        flag_column_name=MUTEPRED_TRAINING_FLAG_COLUMN_NAME)

    MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE = add_data_from_list_of_tools(MAVE_GS_DATAFRAME_HUMAN_WITH_BASELINE,
                                                                        db_nsfp_output_dir_path=OUTPUT_DIR_DB_NSFP,
                                                                        tool_list=TOOLS_LIST,
                                                                        snp_column_name=SNP_COLUMN_NAME)
