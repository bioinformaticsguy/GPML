...
from src.constants import PICKLED_DATAFRAMES_DIRECTORY_PATH, \
    ...
    DEOGEN_TOOL_NAME, EXCLUDE_TRAINING_SAV_SUFFIX, TOOLS_LIST, PLOTS_DIRECTORY_PATH, PLOT_FORMAT
...
if __name__ == '__main__':
    ...
    file_name = PLOTS_DIRECTORY_PATH / Path(MUTEPRED_TOOL_NAME + DEOGEN_TOOL_NAME + "all_exclude" + "." + PLOT_FORMAT)
    column1 = MUTEPRED_TOOL_NAME + SPEAR_COR_SUFFIX + EXCLUDE_TRAINING_SAV_SUFFIX
    column3 = DEOGEN_TOOL_NAME + SPEAR_COR_SUFFIX + EXCLUDE_TRAINING_SAV_SUFFIX
    column2 = MUTEPRED_TOOL_NAME + SPEAR_COR_SUFFIX
    column4 = DEOGEN_TOOL_NAME + SPEAR_COR_SUFFIX



    column_names = [id_column, baseline_column, column1, column2, column3, column4]
    sorted_df = LOADED_MAVE_DF.loc[:, column_names].sort_values(by=baseline_column, ascending=True)
