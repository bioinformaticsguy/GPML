...
if __name__ == '__main__':
    ...
    tool_names_list = [MUTEPRED_TOOL_NAME, DEOGEN_TOOL_NAME, CLINPRED_TOOL_NAME]
    file_name = PLOTS_DIRECTORY_PATH / Path(tool_names_list[0] + tool_names_list[2] + "all_exclude" + "." + PLOT_FORMAT)
    column1 = MUTEPRED_TOOL_NAME + SPEAR_COR_SUFFIX + EXCLUDE_TRAINING_SAV_SUFFIX
    column3 = tool_names_list[2] + SPEAR_COR_SUFFIX + EXCLUDE_TRAINING_SAV_SUFFIX
    column2 = MUTEPRED_TOOL_NAME + SPEAR_COR_SUFFIX
    column4 = tool_names_list[2] + SPEAR_COR_SUFFIX
