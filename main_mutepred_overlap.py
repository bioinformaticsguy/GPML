...
from src.utils import get_dataframe_for_mave_gs_data, COLUMN_NAMES_OF_MAVE_GS_DATAFRAME_LIST
...
MAVE_GS_DATAFRAME = get_dataframe_for_mave_gs_data(MAVE_GS_FILE_PATH,
